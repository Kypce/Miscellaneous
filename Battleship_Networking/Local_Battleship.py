# This code is for 2-players locally
# But this is all the logic for playing battleship

class minibattleship(object):
    ...
    def placeship2(self, board, size):
    ...
    def placeships2(self, board, size, number):
        i = 0
        while i != number:
            check = self.placeship2(board, size[i])
    ...
    def minibattleship(self):
        ...
        self.placeships2(self.p1shipboard, self.ship_sizes, len(self.ship_sizes))
        print('\n\nPlayer 2 is placing their ships!')
        self.placeships2(self.p2shipboard, self.ship_sizes, len(self.ship_sizes))

        while True:
            if self.currentturn == 0:
                print('\n\nPlayer 1 is guessing!')
                self.drawboard(self.p1shipboard)
